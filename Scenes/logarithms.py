...
class IntroductionLogarithm(VoiceoverScene):
    def construct(self):
        ...
        text = """
                ...
                Suppose we have the equation two raised to the power of x equals eight.
                If we ask ourselves, what power of two gives eight, the answer is three, because two times two times two equals eight.
                So, in this case, x equals three.

                This simple question — ‘what power do we raise the base to in order to get the result?’
                — is exactly what a logarithm answers.
               """
        with self.voiceover(text=text) as tracker:
